...
const Header = () => {
	return (
		<header
			className={`flex justify-between items-center relative h-20 opacity-50 before:content[' '] before:size-50 before:bg-blue-500 before:rounded-full before:absolute before:left-1/2 before:-top-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:blur-3xl `}
		>
			...
			<h2 className='text-4xl relative z-10 text-opacity-50 font-bold'>
				Dashboard
			</h2>

			<button className='w-14 text-4xl'>
				<TfiReload />
			</button>
		</header>
	)
